...
ext('ChromeWindowMinimize', e.win.minimize);
ext('ChromeWindowIsMinimized', e.win.isMinimized);
ext('ChromeWindowMaximize', e.win.maximize);
ext('ChromeWindowIsMaximized', e.win.isMaximized);
